...
public class CalculatorTest {
    public static void main(String[] args) {
        ...
        System.out.println(Calculator.areaOfCircle(5));
        System.out.println(Calculator.circumferenceOfCircle(5));
        
        // TODO: 객체 생성 없이 static 메소드를 호출하여 사각형의 면적을 계산하세요.
        System.out.println(Calculator.areaOfRectangle(5, 3));
        
        // TODO: Calculator 객체를 생성하고 인스턴스 메소드를 호출하세요.
        Calculator calculatorA = new Calculator("Casio S3", 50);
        
        // TODO: 생성된 Calculator 객체의 정보를 출력하세요.
        calculatorA.getInfo();

        // TODO: 추가로 Calculator 객체를 생성하고, 객체 생성 횟수를 확인하세요.
        Calculator calculatorB = new Calculator("Casio S4", 80);
        System.out.println(Calculator.totalCalculator);
